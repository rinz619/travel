...
document.querySelectorAll('.plus').forEach(button => {
    button.addEventListener('click', function() {
        // Find the job name associated with this button
        const jobName = this.previousElementSibling.querySelector('p').textContent;
        
        // Create a new container div for the job name and the remove button
        const jobContainer = document.createElement('div');
        jobContainer.classList.add('job-container');

        // Create a new paragraph element with the job name
        ...
        // Append the job name and remove button to the job container
        jobContainer.appendChild(jobElement);
        jobContainer.appendChild(removeButton);
        
        // Append the job container to the right side card
        document.querySelector('.right-card').appendChild(jobContainer);

        // Add event listener to the remove button to remove the job container
...
$(document).ready(function () {
  ...
  let copyText2 = document.querySelector(".copy-text1");
  copyText2.querySelector("button").addEventListener("click", function () {
      let input = copyText2.querySelector("input.text1");
      input.select();
      document.execCommand("copy");
